...
async def get_preferences(
    ...
    return PreferencesResponse(
        ...
        profanity_filter_enabled=pref.profanity_filter_enabled if pref.profanity_filter_enabled is not None else False,
    )
...
async def update_preferences(
    ...
    if body.profanity_filter_enabled is not None:
        pref.profanity_filter_enabled = body.profanity_filter_enabled
        logger.info("update_preferences: profanity_filter_enabled=%s for user_id=%s", body.profanity_filter_enabled, current_user.id)
