...
4. **Typesetting** — Generates a print-ready interior PDF using Typst. Includes proper front matter (half-title, title page, copyright), chapter detection, running headers, page numbers, and back matter with attribution and QR codes. Optional profanity filtering replaces sensitive words with █ blocks in the printed text.
