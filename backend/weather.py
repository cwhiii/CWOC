...
from backend.db import DB_PATH, _update_lock, serialize_json_field
...
async def _geocode_address(address):
    ...
    from backend.routes.health import _geocode_cache, _geocode_lock, _geocode_last_req, _sync_geocode_fetch
    import backend.routes.health as _health_mod
...
async def start_weather_schedulers():
    ...
    from backend.routes.audit import _run_auto_prune
