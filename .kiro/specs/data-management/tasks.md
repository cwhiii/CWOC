...
- [ ] 1. Add backend export endpoints and data models
  - [ ] 1.1 Add `ImportRequest` Pydantic model and Export Envelope builder helper in `backend/main.py`
  ...
  - [ ] 1.2 Implement `GET /api/export/chits` endpoint
  ...
  - [ ] 1.3 Implement `GET /api/export/userdata` endpoint
