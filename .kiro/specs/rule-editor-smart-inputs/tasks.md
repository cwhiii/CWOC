...
- [x] 1. Add missing email fields and operator filtering
  - [x] 1.1 Add email_to, email_cc, email_bcc, email_account_id to EMAIL_FIELDS array in `rule-editor.js`
...
- [x] 2. Implement smart input factory and simple dropdowns
  - [x] 2.1 Create `_renderSmartInput(leaf, onChange)` factory function in `rule-editor.js`
  ...
  - [x] 2.2 Implement priority, status, severity, and boolean dropdown widgets
  ...
  - [x] 2.3 Implement email account dropdown widget
  ...
  - [x]* 2.4 Write property tests for smart input type mapping and operator filtering
...
- [x] 3. Implement contact autocomplete widget
  - [x] 3.1 Create `_renderContactAutocomplete(options)` reusable component in `rule-editor.js`
  ...
  - [x] 3.2 Wire contact autocomplete for email fields and people field
  ...
  - [x]* 3.3 Write property test for autocomplete filtering
    - **Property 3: Autocomplete Filtering** — verify at most 10 results, case-insensitive substring match against name/email
    - **Validates: Requirements 2.2, 10.2**

- [x] 4. Implement location combobox and color swatches
  - [x] 4.1 Create location combobox widget (dropdown + text input)
  ...
  - [x] 4.2 Create color swatches widget
  ...
  - [x] 4.3 Wire tag picker for tags field (reuse existing pattern)
  ...
  - [x]* 4.4 Write property tests for dropdown pre-selection, account labels, and tag sorting
...
- [x] 6. Implement weather condition fields (frontend)
  - [x] 6.1 Add WEATHER_FIELDS array and conditional display in field dropdown
  ...
  - [x] 6.2 Create weather smart input (numeric input + location selector)
...
- [x] 7. Implement Create Chit action (frontend)
  - [x] 7.1 Add "Create Chit" to CHIT_ACTION_TYPES and implement `_renderCreateChitAction` panel
...
- [x] 8. Add CSS styles for smart input widgets
  - [x] 8.1 Add `.smart-input-*` CSS classes to `shared-page.css`
...
- [x] 9. Add HTML templates for smart input widgets
  - [x] 9.1 Add `<template>` elements to `rule-editor.html`
...
- [x] 11. Implement weather condition evaluation (backend)
  - [x] 11.1 Add weather condition evaluation to `evaluate_leaf()` in `rules_engine.py`
  ...
  - [x]* 11.2 Write property test for weather numeric comparison
...
- [x] 12. Implement Create Chit action executor (backend)
  - [x] 12.1 Add `create_chit` action handler to `execute_action()` in `rules_engine.py`
  ...
  - [x]* 12.2 Write property test for template placeholder resolution
  ...
  - [x]* 12.3 Write property test for Create Chit record validity
...
- [x] 14. Update Mega Index, version, and release notes
  - [x] 14.1 Update `src/INDEX.md` with all new functions, templates, and CSS sections
  ...
  - [x] 14.2 Update version number in `src/VERSION` and create release notes
