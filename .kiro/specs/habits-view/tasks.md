...
- [x] 1. Backend data model and migrations
  - [x] 1.1 Add `hide_when_instance_done` field to the Chit model and CRUD operations
  ...
  - [x] 1.2 Add `habits_success_window` field to the Settings model and CRUD operations
  ...
  - [x] 1.3 Add `migrate_add_habits_fields()` migration function
...
- [x] 3. Shared helper functions in `frontend/shared.js`
  - [x] 3.1 Implement `getCurrentPeriodDate(chit)` function
  ...
  - [x] 3.2 Implement `getHabitSuccessRate(chit, windowDays)` function
  ...
  - [x] 3.3 Implement `getHabitStreak(chit)` function
  ...
  - [x] 3.4 Write property test for `getCurrentPeriodDate`
  ...
  - [x] 3.5 Write property test for `getHabitSuccessRate`
  ...
  - [x] 3.6 Write property test for `getHabitStreak`
...
- [x] 4. Checkpoint — Shared helpers complete
  - Ensure all tests pass, ask the user if questions arise.

- [x] 5. Frontend Habits view rendering in `frontend/main.js`
  - [x] 5.1 Add view mode state variable and `_setTasksMode()` function
  ...
  - [x] 5.2 Add habits mode dispatch in `displayTasksView()`
  ...
  - [x] 5.3 Implement `displayHabitsView(chitsToDisplay)` function
  ...
  - [x] 5.4 Implement completion checkbox toggle handler
  ...
  - [x] 5.5 Write property test for completion-based sort ordering
...
- [x] 6. Sidebar view mode toggle in `frontend/index.html` and `frontend/main.js`
  - [x] 6.1 Add Tasks view mode toggle HTML in sidebar
  ...
  - [x] 6.2 Wire sidebar section visibility to tab switching
...
- [x] 7. Editor — "Hide from Habits when done" checkbox
  - [x] 7.1 Add checkbox HTML in `frontend/editor.html`
  ...
  - [x] 7.2 Wire checkbox visibility and load/save in `frontend/editor.js`
...
- [x] 8. Settings — Success window dropdown
  - [x] 8.1 Add Habits section HTML in `frontend/settings.html`
  ...
  - [x] 8.2 Wire dropdown load/save in `frontend/settings.js`
...
- [x] 9. Habit card CSS styles in `frontend/styles.css`
  - [x] 9.1 Add habit card CSS classes
...
- [x] 10. Checkpoint — All features wired together
  - Ensure all tests pass, ask the user if questions arise.

- [x] 11. Help documentation and version update
  - [x] 11.1 Update `frontend/help.html` with Habits view documentation
