...
- [x] 1. Android App — Extract shared formatting utilities
  - [x] 1.1 Create `MarkdownFormatUtils.kt` shared utility object
  ...
  - [x] 1.2 Refactor `NotesZone` to use shared `MarkdownFormatUtils`
...
- [x] 2. Android App — Restructure EmailComposeZone layout
  - [x] 2.1 Restructure `EmailComposeZone.kt` to Column with three sections
  ...
  - [x] 2.2 Implement Address Header scrollable section
  ...
  - [x] 2.3 Implement Email Bottom Toolbar composable
...
- [x] 3. Android App — Implement toolbar functionality
  - [x] 3.1 Wire formatting buttons to shared `MarkdownFormatUtils`
  ...
  - [x] 3.2 Implement Undo/Redo state management for email body
  ...
  - [x] 3.3 Implement Preview/Edit toggle for email body
  ...
  - [x] 3.4 Implement Email Overflow Menu (⋮) with context-dependent items
...
- [x] 4. Checkpoint — Android app complete
  - Ensure all changes compile, ask the user if questions arise.

- [x] 5. Mobile Web — Create bottom-pinned email toolbar
  - [x] 5.1 Create `_createMobileEmailToolbar()` function in `editor-email.js`
  ...
  - [x] 5.2 Implement keyboard tracking and toolbar visibility
  ...
  - [x] 5.3 Wire formatting buttons to existing `_emailFormatBtn()` function
  ...
  - [x] 5.4 Implement Undo/Redo for mobile email toolbar
  ...
  - [x] 5.5 Implement Preview/Edit toggle for mobile email toolbar
  ...
  - [x] 5.6 Implement Overflow Menu dropdown with context-dependent items
    - Draft menu: Send, Send Later, Send & Archive, PGP Encrypt toggle, Copy body, Discard draft
    - Received menu: Reply, Forward, Archive, Copy body, Download, Add sender to contacts
    - Sent menu: Forward, Copy body, Download
  ...
  - [x] 5.7 Hide zone-header action buttons on mobile (≤768px)
...
- [x] 6. Mobile Web — Email body fills remaining space
  - [x] 6.1 Implement auto-grow body textarea behavior
