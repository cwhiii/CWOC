...
- [-] 4. Phase 4 — Move backend to src/backend/
  - [x] 4.1 Move all backend Python files into `src/backend/`
  ...
  - [x] 4.2 Update all intra-backend Python imports
    ...
    - _Requirements: 2.5_
  - [x] 4.3 Update `DB_PATH` to reference the flattened data directory
  ...
  - [x] 4.4 Update `StaticFiles` mounts in `src/backend/main.py`
  ...
  - [x] 4.5 Update `FileResponse` paths for HTML page serving
  ...
  - [-] 4.10 Remove old `backend/` directory
    ...
    - _Requirements: 1.1_
  - [x] 4.11 Verify backend runs from new location
  ...
  - [x] 4.12 Update `mega_restructure_plan.md` — mark Phase 4 complete
    - _Requirements: 14.6_
