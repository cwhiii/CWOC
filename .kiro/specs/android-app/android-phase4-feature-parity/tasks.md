...
- [ ] 1. Database migration and domain layer foundations
  - [ ] 1.1 Create database migration v3 → v4
  ...
  - [ ] 1.2 Implement Boolean Search parser and evaluator
  ...
  - [ ]* 1.3 Write property tests for Boolean Search
  ...
  - [ ] 1.4 Implement Recurrence Engine
  ...
  - [ ]* 1.5 Write property tests for Recurrence Engine
  ...
  - [ ] 1.6 Implement Checklist domain operations
  ...
  - [ ]* 1.7 Write property tests for Checklist operations
  ...
  - [ ] 1.8 Implement Alert classification
  ...
  - [ ]* 1.9 Write property tests for Alert classification
    - **Property 8: Alert classification partitions correctly**
    - **Validates: Requirements 3.2, 3.3**

  - [ ] 1.10 Implement Chart data transformer
  ...
  - [ ]* 1.11 Write property tests for Chart data transformer
  ...
  - [ ] 1.12 Implement Kanban status grouping
  ...
  - [ ]* 1.13 Write property tests for Kanban grouping
...
- [ ] 3. Swipe actions and dirty tracking
  - [ ] 3.1 Implement swipe action logic
  ...
  - [ ]* 3.2 Write property test for swipe undo
  ...
  - [ ] 3.3 Implement swipe gesture composable
...
- [ ] 4. New C CAPTN view screens
  - [ ] 4.1 Implement Checklists View
  ...
  - [ ] 4.2 Implement Projects/Kanban View
  ...
  - [ ] 4.3 Implement Alerts/Alarms View
  ...
  - [ ] 4.4 Implement Indicators/Health Charts View
  ...
  - [ ]* 4.5 Write unit tests for new view screens
...
- [ ] 6. Map integration
  - [ ] 6.1 Configure osmdroid and implement Map Screen
  ...
  - [ ]* 6.2 Write unit tests for map marker logic
...
- [ ] 7. Home screen widgets
  - [ ] 7.1 Implement Quick Add Widget
  ...
  - [ ] 7.2 Implement Today Calendar Widget
  ...
  - [ ] 7.3 Implement Upcoming Tasks Widget
  ...
  - [ ] 7.4 Implement Widget data provider and refresh worker
  ...
  - [ ]* 7.5 Write unit tests for widget data queries
...
- [ ] 9. Contact list and pull-to-refresh
  - [ ] 9.1 Implement Contact List Screen
  ...
  - [ ]* 9.2 Write property tests for contact list
  ...
  - [ ] 9.3 Implement Pull-to-Refresh wrapper
...
- [ ] 10. Navigation, animations, and search integration
  - [ ] 10.1 Update bottom navigation to full C CAPTN
  ...
  - [ ] 10.4 Integrate Boolean Search into main list screen
    - Add search input to main chit list screen
    - Wire to `BooleanSearchParser` + `BooleanSearchEvaluator`
    - Real-time filtering with 300ms debounce
    - _Requirements: 11.1, 11.7_

  - [ ] 10.5 Integrate Recurrence Engine into calendar/task views
  ...
  - [ ] 10.6 Wire Map Screen and Contact List into navigation
