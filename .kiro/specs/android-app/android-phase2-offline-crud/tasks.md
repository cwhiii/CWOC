...
- [ ] 1. Database migration and entity updates
  - [ ] 1.1 Add dirty tracking columns to ChitEntity and create Room migration
  ...
  - [ ] 1.2 Extend ChitDao with dirty tracking and CRUD queries
...
- [ ] 2. Data layer — DTOs, mappers, and API extension
  - [ ] 2.1 Create push request/response DTOs
  ...
  - [ ] 2.2 Create Entity↔FormState and Entity→PushDto mappers
  ...
  - [ ] 2.3 Add pushChanges endpoint to CwocApiService
    - Add `@POST("/api/sync/push") suspend fun pushChanges(request): Response<SyncPushResponseDto>`
    - _Requirements: 7.1, 13.3_

  - [ ]* 2.4 Write property tests for Entity↔FormState round-trip and Entity→PushDto mapping
...
- [ ] 3. Dirty tracking system
  - [ ] 3.1 Implement DirtyTracker interface and DirtyTrackerImpl
  ...
  - [ ]* 3.2 Write property tests for dirty field tracking
...
- [ ] 4. Connectivity monitoring
  - [ ] 4.1 Implement ConnectivityMonitor interface and ConnectivityMonitorImpl
...
- [ ] 5. Sync push engine
  - [ ] 5.1 Implement SyncPushEngine interface and SyncPushEngineImpl
  ...
  - [ ]* 5.2 Write property tests for push response handling
...
- [ ] 7. WebSocket client
  - [ ] 7.1 Implement WebSocketClient interface and WebSocketClientImpl
...
- [ ] 8. WorkManager push-on-reconnect
  - [ ] 8.1 Implement PushSyncWorker
...
- [ ] 9. Sync state management and orchestration
  - [ ] 9.1 Implement SyncStateManager
  ...
  - [ ] 9.2 Implement SyncOrchestrator
...
- [ ] 10. Dependency injection — SyncModule
  - [ ] 10.1 Create SyncModule Hilt module
...
- [ ] 11. Checkpoint — Sync infrastructure complete
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 12. Chit Editor screen
  - [ ] 12.1 Create ChitFormState data class
    - Define in `data/mapper/ChitMapper.kt` or a dedicated file
    - Include all editable fields with defaults
    - _Requirements: 1.2, 1.3_

  - [ ] 12.2 Implement ChitEditorViewModel
  ...
  - [ ] 12.3 Create ChitEditorScreen Compose UI
...
- [ ] 14. Update existing screens — Tasks, Notes, Calendar
  - [ ] 14.1 Update TasksScreen and TasksViewModel with FAB, swipe, and click-to-edit
...
- [ ] 15. Integration wiring and app startup
  ...
  - [ ] 15.2 Ensure Room reactive queries update all views on local writes
