...
- [x] 1. Database migration and new entities
  - [x] 1.1 Create ContactEntity, SettingsEntity, and AttachmentMetadata Room entities
  ...
  - [x] 1.2 Create ContactDao, SettingsDao, and AttachmentMetadataDao
  ...
  - [x] 1.3 Implement MIGRATION_2_3 and update CwocDatabase to version 3
...
- [x] 2. Checkpoint — Ensure database compiles and migration is correct
  - Ensure all tests pass, ask the user if questions arise.

- [x] 3. Conflict banner and conflict state handling
  - [x] 3.1 Add conflictFields column to ChitEntity and extend ChitDao
  ...
  - [x] 3.2 Implement ConflictBanner composable
  ...
  - [x] 3.3 Extend ChitEditorViewModel with conflict dismiss logic
...
- [x] 4. Contacts CRUD and sync
  ...
  - [x] 4.2 Implement ContactEditorViewModel
  ...
  - [x] 4.3 Extend DirtyTracker for contacts and settings
...
- [x] 5. Settings sync
  - [x] 5.1 Implement SettingsRepository
  ...
  - [x] 5.2 Implement settings conflict resolution (LWW)
...
- [x] 6. Extended push sync engine
  - [x] 6.1 Extend SyncPushEngine to include contacts and settings
  ...
  - [x] 6.2 Create push/pull DTOs for contacts and settings
  ...
  - [x] 6.3 Handle conflict state from push response (chits + contacts)
...
- [x] 7. Checkpoint — Ensure sync compiles and contacts/settings flow works
  - Ensure all tests pass, ask the user if questions arise.

- [x] 8. Attachment management
  - [x] 8.1 Implement AttachmentCache with LRU eviction
  ...
  - [x] 8.2 Implement AttachmentManager (download + upload + cache orchestration)
...
- [x] 9. Local notifications
  - [x] 9.1 Implement NotificationChannelManager
  ...
  - [x] 9.2 Implement NotificationScheduler
  ...
  - [x] 9.3 Implement AlarmReceiver BroadcastReceiver
  ...
  - [x] 9.4 Implement BootReceiver for alarm re-registration
  ...
  - [x] 9.5 Update AndroidManifest with permissions and receivers
...
- [x] 11. Edge case handling
  - [x] 11.1 Implement EdgeCaseHandler (delete-vs-edit, tag rename, checklist LWW)
...
- [x] 12. Dependency injection and wiring
  - [x] 12.1 Create Phase3Module for Hilt DI
  ...
  - [x] 12.2 Wire notification channel creation and alarm permission prompt
  ...
  - [x] 12.3 Wire PushSyncWorker to include contacts and settings
...
- [x] 13. Final checkpoint — Ensure all components compile and integrate
  - Ensure all tests pass, ask the user if questions arise.
