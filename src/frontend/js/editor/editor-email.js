...
function _setEmailZoneReadOnly(readOnly) {
  ...
  // Hide inline format toolbar for received/sent emails
  var inlineToolbar = document.getElementById('emailInlineFormatToolbar');
  if (inlineToolbar) inlineToolbar.style.display = readOnly ? 'none' : '';
