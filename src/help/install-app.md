...
1. Go to **[Settings](/frontend/html/settings.html) → 📱 Install as App** and tap **"📜 Download Server Certificate"**. This downloads the CA certificate that signed your server's SSL cert.
...
- Go to **[Settings](/frontend/html/settings.html) → 📱 Install as App**. If your browser supports direct install, a **"📲 Install CWOC App"** button will appear — click it and confirm.
...
- To get a real standalone app, go to **[Settings](/frontend/html/settings.html) → 📱 Install as App** and tap **"🌐 Open in Chrome to Install"**. This launches Chrome directly to your CWOC server.
...
- Go to **[Settings](/frontend/html/settings.html) → 📱 Install as App** and tap **"📲 Install CWOC App"** if the button appears.
