...
Periods: Itinerary, Day, Week, Work Hours, X Days, Month, Year. Switch with the Period dropdown or `.` hotkey.

- **Start & end times** → timed blocks
- **Due date only** → ⌚ icon
- **All-day** → all-day bar at top
...
**See also:** [Views](/frontend/html/help.html#views) · [Chit Editor](/editor) · [Recurrence](/frontend/html/help.html#recurrence) · [Weather](/frontend/html/weather.html)
