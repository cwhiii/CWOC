...
The Indicators view displays health and activity data tracked via the [Custom Objects](custom-objects.md) system. Access it from the dashboard tab bar. Three display modes are available via a pill toggle at the top:
...
The selected mode and graph filter selections persist in localStorage between visits. A ⚙️ Objects link in the header navigates to the Custom Objects Editor for managing indicator definitions.

---

**See also:** [Views](views.md) · [Custom Objects](custom-objects.md) · [Chit Editor](editor.md)
