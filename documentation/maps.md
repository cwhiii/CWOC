...
Configure how the map opens each time in **Settings → 🗺️ Map Settings**:
...
Click a contact marker to see a popup with the contact's name, address, organization, phone, and email (when available). Click **"Open Contact"** in the popup to go to the contact editor. Contact markers use a distinct square shape so they're easy to tell apart from chit markers.
...
If "Prefer Google for Maps" is enabled in Settings → Chit Options, the Maps View displays a warning message instead of loading the map. Google Maps is not supported for this feature due to billing restrictions. Disable the preference in Settings to use the Maps View.

---

**See also:** [Views](views.md) · [Contacts](contacts.md) · [Settings](settings.md) · [Saved Locations](saved-locations.md)
